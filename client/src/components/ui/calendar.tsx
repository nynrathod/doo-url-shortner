...
export function Calendar({ className, value, onChange, minDate }: CalendarProps) {
                    ...
                    >
                        <button
                            ...
                            className={cn(
                                ...
                                !isSameDay(day, value || new Date(0)) && isToday(day) && 'text-blue-600 font-semibold',
                                !isSameDay(day, value || new Date(0)) && !isToday(day) && 'text-gray-900',
                                isSameDay(day, value || new Date(0)) && 'bg-black',
                                !isSameDay(day, value || new Date(0)) && 'hover:bg-gray-100',
                                (isSameDay(day, value || new Date(0)) || isToday(day)) && 'font-semibold',
