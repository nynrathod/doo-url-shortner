        ...
        <DashboardLayout>
            <div className="flex flex-col h-full p-6 pb-24 lg:pb-6">
                ...
                {isLoading ? (
                    ...
                    <div className="flex-1 min-h-0 border border-gray-200 rounded-lg overflow-y-auto">
                ...
                {/* Pagination info */}
                {filteredLinks.length > 0 && (
                    <div className="flex items-center justify-center gap-2 mt-4 mb-4 text-xs text-gray-500">
